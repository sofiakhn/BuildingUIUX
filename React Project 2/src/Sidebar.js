...
class Sidebar extends React.Component {
  ...
  // setInterests() {
  //   if(this.interest.current != null && this.minimumCredits.current != null && this.maximumCredits.current != null) {
  //     this.props.setCourses(this.searchAndFilter.searchAndFilter(this.props.interest,this.search.current.value, this.subject.current.value, this.minimumCredits.current.value, this.maximumCredits.current.value,this.interest.current.value));
  //   }
  // }
  ...
  getInterestOptions() {
    let arr = ['All', 'algebra','behavior','brain','ecology' , 'law', 'programming', 'trigonometry'];
    let interestOptions = [];
